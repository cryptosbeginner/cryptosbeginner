...
const structuredData = [
  {
    ...
    about: { "@type": "Thing", name: "Cryptocurrency market data" },
  },
  {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: { "@type": "Answer", text: "The tracker shows provider-supplied price, market rank, market capitalization, 24-hour volume, and recent percentage changes for the assets returned by CoinStats or the CoinGecko fallback. Each response includes a provider name and checked timestamp." },
      },
      {
        "@type": "Question",
        name: "Is this crypto tracker financial advice?",
        acceptedAnswer: { "@type": "Answer", text: "No. It is an educational market-data interface. Prices and market statistics are time-stamped snapshots and do not establish suitability, future performance, liquidity, execution quality, or safety." },
      },
    ],
  },
];
