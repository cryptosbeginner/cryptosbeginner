        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:gap-16">
          <div className="max-w-3xl">
            ...
            <p className="mt-7 max-w-2xl text-lg leading-9 text-slate-200 sm:text-xl">
              ...
              suitable for your risk tolerance. Start with a repeatable research
              process before you connect a wallet or sign a trade.
            </p>
          ...
          <figure className="overflow-hidden rounded-3xl border border-slate-700 bg-slate-900 shadow-2xl shadow-black/30">
            ...
            <figcaption className="border-t border-slate-700 px-5 py-4 text-base leading-7 text-slate-300">
              Research tools can help organize market information. They do not
              replace contract checks, liquidity analysis, or a risk plan.
            </figcaption>
          </figure>
        </div>
      </Section>
      ...
      <Section id="tool-types" className="bg-slate-50">
        <div className="max-w-4xl">
          ...
          <p className="mt-6 text-lg leading-9 text-slate-700">
            Most beginner mistakes start with using the wrong tool for the wrong
            question. A trading terminal may help you monitor and route a
            transaction. A launchpad may help create or discover a token. A
            charting tool or blockchain explorer can help verify activity. None
            of these tools independently validates a meme coin.
          </p>
        </div>
        ...
        <div className="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:gap-16">
          <div>
            ...
            <p className="mt-6 text-lg leading-9 text-slate-700">
              ...
              process creates opportunities to stop before a small mistake turns
              into a wallet, approval, or liquidity problem.
            </p>
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 text-lg leading-9 text-slate-700">
              ...
              credentials, and how to use AI-assisted research without handing
      ...
      <Section className="bg-[#fff5f3]">
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16">
          <div className="max-w-xl">
            ...
            <p className="mt-6 text-lg leading-9 text-slate-700">
              These signals do not automatically prove fraud. They do mean you
              should slow down, verify more information, use less exposure, or
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 text-lg leading-9 text-slate-200">
              A correct token address is not enough if a wallet prompt requests
              an approval or transaction you do not understand. Review the
              network, asset, allowance, recipient, route, fees, and slippage
      ...
      <Section className="border-t border-slate-200 bg-slate-50">
        <div className="rounded-3xl border border-slate-200 bg-white p-7 sm:p-9">
          ...
          <p className="mt-4 max-w-5xl text-lg leading-9 text-slate-700">
            ...
            fees, and editorial interpretation. Platform pages may use official
            documentation, product screenshots, supplied videos, and on-chain
            research references. Features, fees, availability, and legal terms
            can change, so verify the provider before connecting a wallet or
