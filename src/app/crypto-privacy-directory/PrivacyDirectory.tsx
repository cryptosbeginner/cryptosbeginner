...
import { privacyReferenceServices } from "./reference-services";
...
const reviewedServiceNames = new Set(services.map((service) => normalizeServiceName(service.name)));
const allServices: PrivacyService[] = [
  ...services,
  ...privacyReferenceServices.filter(
    (service) => !reviewedServiceNames.has(normalizeServiceName(service.name)),
  ),
];

const categoryDescriptions: Record<DirectoryCategory, string> = {
  All: "Every reviewed profile and source-labeled reference entry in the directory.",
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-slate-600">
                Browse {allServices.length} catalog entries. This is a research
        ...
        <section className="max-w-6xl mx-auto px-4 py-14">
          ...
          <div className="mt-7 grid gap-5 md:grid-cols-2">
            ...
            <details className="rounded-2xl border border-slate-200 p-5">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">
                No. The catalog groups reviewed profiles and reference entries by model and highlights
