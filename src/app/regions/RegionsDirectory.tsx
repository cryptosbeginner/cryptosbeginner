...
const regions: RegionGroup[] = [
  ...
  },
  {
    ...
    intro:
      "Large trading volume and strong purchasing power, but platform access changes by country, province and state.",
    countries: [
      {
        name: "United States",
      ...
      <section className="bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 text-white">
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-20">
          ...
          <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-300">
            The right exchange depends on where you live. We explain local
            regulation, taxes, payment methods, P2P risks, exchange access
            and custody before you deposit funds.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-300">
                We cover custody, Proof of Reserves, incident history, P2P
                risk and self-custody basics.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-5 md:grid-cols-3">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Learn the relevant regulator, licence framework, consumer
                protections and local restrictions.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Understand local tax treatment for sales, swaps, staking,
                mining, wealth and exchange reporting.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Compare local currency rails, bank transfers, cards, mobile
                money, P2P and wallet risks.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 leading-7 text-slate-600">
                A platform can accept registrations from a country without
                being licensed there, offering every product there or
                providing local consumer protection. Before depositing,
                check the legal entity, regulator, custody terms, payment
                route and tax consequences.
              </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-slate-200 bg-white p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Confirm the provider and service in the relevant official
                  register.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Save trades, swaps, rewards and wallet transfers from the
                  first transaction.
                </p>
              </div>
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2">
            <details className="rounded-2xl border border-slate-700 p-5">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-300">
                ...
                platform depends on where you live, local licensing, payment
                methods, tax rules, product access and fees.
              </p>
            </details>
            ...
            <details className="rounded-2xl border border-slate-700 p-5">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-300">
                Licensing, banking rules, sanctions, tax reporting, product
                restrictions and local payment infrastructure differ between
                jurisdictions.
              </p>
            </details>
            ...
            <details className="rounded-2xl border border-slate-700 p-5">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-300">
                Technical access does not prove legal authorisation or local
                consumer protection. Check the country guide and the
                platform&apos;s exact legal entity first.
              </p>
            </details>
            ...
            <details className="rounded-2xl border border-slate-700 p-5">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-300">
                ...
                availability, fees and tax treatment can change, so verify
