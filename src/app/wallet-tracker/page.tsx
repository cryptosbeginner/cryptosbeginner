...
export const metadata: Metadata = { title: "Public Wallet Tracker | Balances, P/L & DeFi Research", description: "Use a read-only public wallet tracker to review balances, provider-reported performance, and DeFi positions without submitting a seed phrase or private key.", alternates: { canonical: PAGE_URL }, openGraph: { title: "Public Wallet Tracker | CryptosBeginner", description: "Read-only wallet research for public addresses, with clear privacy and provider-cost boundaries.", url: PAGE_URL, type: "website" } };
