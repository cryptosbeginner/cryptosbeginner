    ...
    <footer className="bg-slate-950 text-slate-400 text-sm">
      <div className="max-w-6xl mx-auto px-4 py-12 grid md:grid-cols-4 gap-8">
        <div>
          ...
          <p>
            Independent crypto education and exchange comparisons for beginners.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/exchanges/best-crypto-exchanges-2026">
                Best Exchanges
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/tools/exchange-finder">Exchange Quiz</Link>
            </li>
            <li>
              <Link href="/learn">Learn hub</Link>
            </li>
            <li>
              <Link href="/security/exchange-incidents">
                Security incidents
              </Link>
            </li>
            <li>
              <Link href="/wallets/best-crypto-wallets-2026">
                Wallets
              </Link>
            </li>
            <li>
